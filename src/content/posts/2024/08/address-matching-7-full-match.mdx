...
```csharp
    public string? Match(string address)
    {
        ...
        state = MatchPart(state, c => c.StreetName, Tolerance);
        ...
        state = SplitMatchedField(state);
        state = MatchPart(state, c => c.BuildingName, Tolerance);
        ...
        state = SplitMatchedField(state);
        state = MatchPart(state, c => c.BuildingNumber, Tolerance);
        ...
        state = SplitMatchedField(state);
        state = MatchPart(state, c => c.SubBuilding, Tolerance);
        ...
        state = SplitMatchedField(state);
        state = MatchPart(state, c => c.Organisation, Tolerance);
